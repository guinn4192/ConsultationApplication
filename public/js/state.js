// state.js — Sprint 6: single source of truth.
...
const _state = {
  userUuid: null, // Sprint 7 で埋める。Sprint 6 では常に null
  sessionId: null, // 初回送信時に採番
...
// エクスポート: Sprint 7 で router / api.js から直接 UUID を採番するため外出し。
export { genUuid };
